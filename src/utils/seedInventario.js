...
const CATEGORIAS = [
  ...
  { name: 'Heladería', icon: '🍦', code: 'HEL', order: 4 },
  { name: 'Granos y Cereales', icon: '🌾', code: 'GRA', order: 5 },
  { name: 'Enlatados', icon: '🥫', code: 'ENL', order: 6 },
  { name: 'Carnes y Embutidos', icon: '🥩', code: 'CAR', order: 7 },
  { name: 'Panadería', icon: '🥐', code: 'PAN', order: 8 },
  { name: 'Frutas y Verduras', icon: '🥬', code: 'FRV', order: 9 },
  { name: 'Aseo Personal', icon: '🧴', code: 'ASP', order: 10 },
  { name: 'Aseo Hogar', icon: '🧹', code: 'ASH', order: 11 },
  { name: 'Medicamentos', icon: '💊', code: 'MED', order: 12 },
  { name: 'Licor', icon: '🍸', code: 'LIC', order: 13 },
  { name: 'Cigarrillos', icon: '🚬', code: 'CIG', order: 14 },
  { name: 'Papelería', icon: '📚', code: 'PAP', order: 15 },
  { name: 'Mascotas', icon: '🐶', code: 'MAS', order: 16 },
  { name: 'Pagos y Recargas', icon: '📱', code: 'REC', order: 17 },
  { name: 'Otros', icon: '📦', code: 'OTR', order: 18 }
];

// ─── Datos de proveedores con códigos únicos (2 números) ────────
const PROVEEDORES = [
  { name: 'Aguila Roja', code: '01' },
  { name: 'Veladoras San Jorge', code: '02' },
  { name: 'Panadería la 12', code: '03' },
  { name: 'Panaderia William', code: '04' },
  { name: 'Postobón gaseosas', code: '05' },
  { name: 'Gaseosas Big', code: '06' },
  { name: 'Coca Cola', code: '07' },
  { name: 'Bavaria', code: '08' },
  { name: 'Lácteos la victoria', code: '09' },
  { name: 'Alpina', code: '10' },
  { name: 'Cream Helado', code: '11' },
  { name: 'La cigarra', code: '12' },
  { name: 'Distribuidora de aguas', code: '13' },
  { name: 'Altipal', code: '14' },
  { name: 'Puyo', code: '15' },
  { name: 'Corbeta', code: '16' },
  { name: 'Prosur Margarita', code: '17' },
  { name: ' Nestlé', code: '18' },
  { name: ' Aliados', code: '19' },
  { name: ' Variedades', code: '20' },
  { name: ' Abraham Delgado', code: '21' },
  { name: ' Bimbo', code: '22' },
  { name: ' Ramo', code: '23' },
  { name: ' Cansur nutrecan', code: '24' },
  { name: ' Surtitiendas', code: '25' },
  { name: ' Distribuidora de Nariño', code: '26' },
  { name: ' Alquería', code: '27' },
  { name: ' Colácteos', code: '28' },
  { name: ' Macpollo', code: '29' },
  { name: ' Pollos Bucanero', code: '30' },
  { name: ' Nutrisur de Nariño', code: '31' },
  { name: ' Col tabacos', code: '32' },
  { name: ' Postillería medicamentos', code: '33' },
  { name: ' Yupi', code: '34' },
  { name: ' Distribuidora Quala', code: '35' },
  { name: ' Adams', code: '36' },
  { name: ' Surti Sur de Nariño', code: '37' },
  { name: ' Distribuidora Ecuador', code: '38' },
  { name: ' Distribuidora dulces y dulces', code: '39' },
  { name: ' Sevillana salchichas', code: '40' },
  { name: ' Arepas Manizales', code: '41' }/*
  { name: '',        code: '42' },
  { name: '',        code: '43' },
  { name: '',        code: '44' },
  { name: '',        code: '45' },
...
const PRODUCTOS_POR_CATEGORIA = {
  'Bebidas': [
    [' El Coca Cola 350ml', 'Coca-Cola FEMSA', 1500, 2000, 48, 12],
